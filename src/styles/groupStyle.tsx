const style = {
	...
	modalBack: 'fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30 w-screen h-screen',
	modal: 'bg-tone-bis p-4 rounded-sm w-96 z-40',
	...
	drawer: 'fixed top-0 left-0 h-full bg-tone-bis text-tint transform transition-transform duration-200 ease-in-out z-20 w-full sm:w-96',
	...
	back: 'fixed inset-0 bg-black opacity-50 z-10'
}
