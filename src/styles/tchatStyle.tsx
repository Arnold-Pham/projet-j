const style = {
	// Conteneur de chat
	tchat: 'overflow-hidden overflow-y-scroll pb-4 px-8 max-h-screen ms-auto',
	...
	bubL: 'px-4 py-3 max-w-full rounded-tr-lg rounded-br-lg text-justify bg-org text-acc break-words',
	...
	bubR: 'px-4 py-3 max-w-full rounded-tl-lg rounded-bl-lg text-justify bg-tone-ter text-tint-one break-words',
	...
	// Formulaire de chat
	tchatForm: 'fixed bottom-0 inset-x-0 p-2 px-8 connect md:ms-80',
